...
SAVE_DIR=/home/guptaa3/Repos/LEXIDATE-EVALUATION/Results/LexiDate-50
...
python /home/guptaa3/Repos/LEXIDATE-EVALUATION/Source/main_sel_obj.py \
--n_jobs 24 \
--savepath ${SAVE_DIR} \
--num_reps 20 \
--proportion .50 \
